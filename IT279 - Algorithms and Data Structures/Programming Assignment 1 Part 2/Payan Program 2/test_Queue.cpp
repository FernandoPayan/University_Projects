...
int main(int argc, char** argv)
{
    ...
    vector<string> allTests = {
            "addOneCustData", "removeOneCustData",
            "addAndRemoveManyCustData", "isEmpty",
            "copyConstructor", "copyConstructorShallowCopy", "addAfterCopy",
            "assignmentOperator", "assignmentOperatorShallowCopy", "assignmentOperatorSelfCopy", "addAfterAssignment"
        };
